...
音檔來源為 Jason 於 2026-06-24 提供的飛創美老闆直式訪談影片，已抽出粉色衣服老闆段落原聲、音量標準化，並切成逐頁可播放片段。
...
- Voice: FSMLAB 粉色衣服老闆影片原聲
- Source video: `../assets/video/fsmlab-owner-source.mp4`
- Format: M4A / AAC / mono / 128 kbps
- 原則：本版只使用粉色衣服老闆的真人聲音，不使用影片後段白色衣服講者，也不使用 macOS `say` 或機器感預設語音。
